...
const EVENT_POINTS: Array<{
  ...
  { id: 'application_submitted',  name: '申込送信時',                desc: 'ユーザーが申込を送信した時',                                              sysUser: 'sys_application_submitted' },
  ...
  { id: 'contract_renewal_reminder', name: '契約終了1ヶ月前',        desc: '契約終了1ヶ月前にユーザーへ更新案内',                                    sysUser: 'sys_contract_renewal_reminder' },
  { id: 'subscription_canceled',  name: '解約通知',                  desc: '管理者がサブスクリプションを解約した時',                                  sysUser: 'sys_subscription_canceled' },
  { id: 'contract_expired',       name: '契約終了時',                desc: '契約期間が終了した時',                                                    sysUser: 'sys_contract_expired' },
  { id: 'device_return_guide',    name: '返却案内',                  desc: '契約終了・解約時に返却手順を案内',                                        sysUser: 'sys_device_return_guide' },
  ...
  { id: 'device_damaged',         name: '破損・不具合通知',          desc: '点検で破損・不具合が見つかった時',                                        sysUser: 'sys_device_damaged' },
